...
<path
  ...
  <symbol id="plan" viewBox="0 0 16 16">
	...
	<main class="d-flex flex-nowrap">
		...
		<div class="container">
			<!-- 여기부터 작업 공간 시작 -->
			<h1 class="pt-5 text-center">시공작업 안전지침을 나타내기 전 날짜/공정 설정</h1>
			<h4 class="pt-3 text-center">
				원하는 날짜에 있는 텍스트박스 안에 공정을 적어주시기 바랍니다.<br /> Example: 거푸집 공사, 콘크리트 타설
			</h4>
			<div
				class="border border-secondary border-3 text-center pt-3 border-3">
				<input type="date" id="dateInput1" disabled />
				<form action="/build/constructOutput" method="get">
					<input type="text" name="construct"> <input type="hidden"
						name="location" value="${location}" /> <input type="hidden"
						name="num" value="1"> <input type="submit" value="안전지침확인" /><br />
				</form>
				<input type="date" id="dateInput2" disabled />
				<form action="/build/constructOutput" method="get">
					<input type="text" name="construct"> <input type="hidden"
						name="location" value="${location}" /> <input type="hidden"
						name="num" value="2"> <input type="submit" value="안전지침확인" /><br />
				</form>
				<input type="date" id="dateInput3" disabled />
				<form action="/build/constructOutput" method="get">
					<input type="text" name="construct"> <input type="hidden"
						name="location" value="${location}" /> <input type="hidden"
						name="num" value="3"> <input type="submit" value="안전지침확인" /><br />
				</form>
			</div>

			<script>
				// Assuming you have received the value of `day1` from the controller
				var day1 = "${day1}"; // Example date
				var day2 = "${day2}";
				var day3 = "${day3}";
				// Set the value of the input element to the value of `day1`
				document.getElementById("dateInput1").value = day1;
				document.getElementById("dateInput2").value = day2;
				document.getElementById("dateInput3").value = day3;
			</script>
			<!-- 여기부터 작업 공간 끝 -->
		</div>
