	...
	<main class="d-flex flex-nowrap">
		...
		<div class="container">
			...
			<c:if test="${plantype == 'construction'}">
				<h1 class="text-center">${dto.dbdate}일자 계획서</h1>
				<table class="table">
					<tbody>
						<tr>
  ...
  ${element}<br />
				...
				<div class="d-flex justify-content-center">
					...
					<button class="btn btn-warning"
						onclick="location='/build/planupdate?dbnum=${dto.dbnum}&plantype=${plantype}'">
						수정하기</button>
					&nbsp;
					<button class="btn btn-danger"
						onclick="location='/build/plandelete?dbnum=${dto.dbnum}&plantype=${plantype}'">
						삭제하기</button>
				</div>
			...
			<c:if test="${plantype == 'design'}">
				<h1 class="text-center">[${dto.dblocation}] 지역의 설계 계획서</h1>
				<table class="table">
					<tbody>
						<tr>
